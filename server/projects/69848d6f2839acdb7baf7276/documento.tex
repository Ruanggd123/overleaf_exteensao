...
\autor{Francisco Ruan Gomes Damasceno}
\titulo{Avaliação de Algoritmos de Agregação Robusta em Aprendizado Federado Sob cenário adversos}
\data{2025}
\local{Sobral}
...
\orientador{Prof. Thiago Iachiley Araujo de Souza}
